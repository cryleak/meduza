...
import com.dazo66.shulkerboxshower.asm.IRegisterTransformer;
import com.dazo66.shulkerboxshower.asm.RegisterTransformer;
...
implements IClassTransformer {
    ...
    public void register(IRegisterTransformer iRegisterTransformer) {
        ...
        if (iRegisterTransformer.getMcVersion().contains(this.MCVERSION)) {
            ...
            FMLLog.log.warn("This MCVersion is {} but Transformer {} accept MCVersion is {} that ignore this Transformer", (Object)this.MCVERSION, (Object)iRegisterTransformer.getClass().getSimpleName(), iRegisterTransformer.getMcVersion());
        }
    }
